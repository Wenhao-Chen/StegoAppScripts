...
public class DCT {
     ...
     */
    private int quantum_luminance[] = new int[this.N * this.N];

    private double DivisorsLuminance[] = new double[this.N * this.N];

    /**
     * Quantitization Matrix for chrominance.
     */
    private int quantum_chrominance[] = new int[this.N * this.N];

    private double DivisorsChrominance[] = new double[this.N * this.N];
     ...
     */
    double[][] forwardDCT(final float input[][]) {
     ...
     */
    int[] quantizeBlock(final double inputData[][], final int code) {
